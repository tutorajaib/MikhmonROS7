...
<div id="sidenav" class="sidenav">
  ...
  <a href="./?map=map&session=<?= $session; ?>" class="menu <?= $shome; ?>"><i class="fa fa-dashboard"></i> Database Maps</a>
  <!-- PPPoE -->
...
<div class="dropdown-container <?= $pppmenu; ?>">
  ...
  <a href="./?ppp=profiles&session=<?= $session; ?>" class="<?= $spprofile; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa fa-user-circle"></i> <?= $_ppp_profiles ?> </a>
  <a href="./?ppp=active&session=<?= $session; ?>" class="<?= $spactive; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa fa-signal"></i> <?= $_ppp_active ?> </a>
</div>
